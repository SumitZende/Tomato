      ...
      <div className="flex flex-col gap-5 mt-7">
        {orederData.map((order, index) => {
          return (
            <div
              key={index}
              className="grid grid-cols-[0.5fr,2fr,1fr,1fr,2fr,1fr] items-center gap-7 text-sm py-[10px] px-5 text-[#454545] border border-tomato
            ...
            >
              ...
              <button
                className="border-none py-3 px-0 rounded bg-[#ffe1e1] cursor-pointer text-[#454545]
                                          max-md:text-[10px]
                                          hover:bg-"
